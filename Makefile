...
build:
	...
	GOOS=linux GOARCH=amd64 go build -o ./websocket/connect/bootstrap ./websocket/connect/cmd/main.go  
	...
	GOOS=linux GOARCH=amd64 go build -o ./websocket/disconnect/bootstrap ./websocket/disconnect/cmd/main.go
	GOOS=linux GOARCH=amd64 go build -o ./websocket/broadcast/bootstrap ./websocket/broadcast/cmd/main.go
...
clean:
	...
	rm -rf ./websocket/broadcast/bootstrap
	rm -rf ./websocket/connect/bootstrap
	rm -rf ./websocket/disconnect/bootstrap
